...
import 'timelineatividade_model.dart';
export 'timelineatividade_model.dart';

class TimelineatividadeWidget extends StatefulWidget {
  const TimelineatividadeWidget({Key? key}) : super(key: key);

  @override
  _TimelineatividadeWidgetState createState() =>
      _TimelineatividadeWidgetState();
}

class _TimelineatividadeWidgetState extends State<TimelineatividadeWidget> {
  late TimelineatividadeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TimelineatividadeModel());
  }
